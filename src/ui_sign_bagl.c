...
prompt_register_delegate(ui_callback_t const ok_cb,
  ...
  push_ui_callback("Address", bip32_path_with_curve_to_pkh_string,
                   &global.path_with_curve);
  push_ui_callback("Fee", microtez_to_string_indirect,
...
bool prompt_transaction(struct parsed_operation_group const *const ops,
  ...
  case OPERATION_TAG_PROPOSAL: {
    ...
    push_ui_callback("Period", number_to_string_indirect32,
  ...
  case OPERATION_TAG_BABYLON_ORIGINATION: {
    ...
    push_ui_callback("Amount", microtez_to_string_indirect,
